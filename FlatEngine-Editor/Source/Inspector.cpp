...
namespace FlatGui {
	...
	void RenderInspector()
	{
		...
		if (focusedObjectID != -1 && FlatEngine::GetObjectById(focusedObjectID) != nullptr)
		{
			...
			//					Sprite* sprite = static_cast<Sprite*>(components[i]);
			...
			//				{
			//					FlatEngine::Animation* animation = static_cast<FlatEngine::Animation*>(components[i]);
			...
			//				{
			//					FlatEngine::Audio* audio = static_cast<FlatEngine::Audio*>(components[i]);
			...
			//				{
			//					// Sprite path and texture dimension variables
			//					FlatEngine::Text* text = static_cast<FlatEngine::Text*>(components[i]);
			...
			//				{						
			//					CharacterController* characterController = static_cast<CharacterController*>(components[i]);
			...
			//				{
			//					BoxCollider* boxCollider = static_cast<BoxCollider*>(components[i]);
			...
			//				{
			//					CircleCollider* circleCollider = static_cast<CircleCollider*>(components[i]);
			...
			//				{
			//					RigidBody* rigidBody = static_cast<RigidBody*>(components[i]);
