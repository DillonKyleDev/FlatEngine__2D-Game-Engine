...
namespace FlatEngine
{
	...
	void Button::SetOnMouseOver(std::function<void(GameObject*)> callback)
	{	
		OnMouseOverFunction = callback;
		_mouseOverSet = true;
	}

	void Button::SetOnMouseEnter(std::function<void(GameObject*)> callback)
	{
		OnMouseEnterFunction = callback;
		_mouseEnterSet = true;
	}

	void Button::SetOnMouseLeave(std::function<void(GameObject*)> callback)
	{
		OnMouseLeaveFunction = callback;
		_mouseLeaveSet = true;
	}

	void Button::SetOnMouseLeftClick(std::function<void(GameObject*)> callback)
	{
		OnLeftClickFunction = callback;
		_leftClickSet = true;
	}

	void Button::SetOnMouseRightClick(std::function<void(GameObject*)> callback)
	{
